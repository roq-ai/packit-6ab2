...
const SidebarContent = ({ onClose, ...rest }: SidebarProps) => {
  ...
  const tenantRoles = ['packaging-designer', 'converter'];
  ...
  const LinkItems: Array<LinkItemProps> = [
    ...
    { name: 'Catalog', path: '/catalogs', entity: 'catalog', service: AccessServiceEnum.PROJECT, icon: FiBookOpen },
    { name: 'Project', path: '/projects', entity: 'project', service: AccessServiceEnum.PROJECT, icon: FiFolder },
    { name: 'Resource', path: '/resources', entity: 'resource', service: AccessServiceEnum.PROJECT, icon: FiFileText },
    { name: 'Review', path: '/reviews', entity: 'review', service: AccessServiceEnum.PROJECT, icon: FiStar },
    { name: 'Supplier', path: '/suppliers', entity: 'supplier', service: AccessServiceEnum.PROJECT, icon: FiTruck },
