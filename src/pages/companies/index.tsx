...
function CompanyListPage() {
  ...
  const { data, error, isLoading, mutate } = useSWR<CompanyInterface[]>(
    ...
    () =>
      getCompanies({
        relations: ['user', 'catalog.count', 'project.count', 'resource.count', 'review.count', 'supplier.count'],
      }),
  );
            ...
            <Table variant="simple">
              <Thead>
                <Tr>
                  ...
                  {hasAccess('catalog', AccessOperationEnum.READ, AccessServiceEnum.PROJECT) && <Th>catalog</Th>}
              ...
              <Tbody>
                {data?.map((record) => (
                  <Tr cursor="pointer" onClick={() => handleView(record.id)} key={record.id}>
                    ...
                    {hasAccess('catalog', AccessOperationEnum.READ, AccessServiceEnum.PROJECT) && (
                      <Td>{record?._count?.catalog}</Td>
                    )}
